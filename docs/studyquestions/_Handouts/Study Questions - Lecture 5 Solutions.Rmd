...
1. Use the web applet on modelled extraterrestrial irradiance (https://geog321.github.io/applets/latitude/) to answer the following questions: 
...
(c) For Montreal QC, when do you expect the highest KEx, and when the lowest? 

You can enter your answer below: 
...
4. Calculate the bulk Atmospheric Transmissivity Ψa for Montreal, QC at 14:00 on February 15th if a pyranometer measures K↓ = 298 W m-2.
...
# define the standard meridian for Montreal
Standard_meridian <- -75

# Define the longitude
long <- -73.5674

# Define the difference between Montreal's longitude and the standard meridian
