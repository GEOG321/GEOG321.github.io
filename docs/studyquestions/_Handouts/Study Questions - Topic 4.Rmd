...
### 2. Calculate the Local Mean Solar Time (LMST) for Montreal, QC if a regular 24h clock shows 14:00 on February 15th, and 08:00 on July 22nd.
...
```{r}
# Next the time offset between LMST and LAT (i.e. delta_LAT), in minutes can be calculated using the formula given in Topic 4, Slide 12
